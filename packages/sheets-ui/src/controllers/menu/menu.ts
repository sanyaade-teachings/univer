...
export function FormatPainterMenuItemFactory(accessor: IAccessor): IMenuButtonItem {
    ...
    return {
        ...
        disabled$: getCurrentRangeDisable$(accessor, { workbookTypes: [UnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.Copy, SubUnitPermissionType.Edit], rangeTypes: [RangeUnitPermissionType.Edit] }),
    };
}
...
export function FontSizeSelectorMenuItemFactory(accessor: IAccessor): IMenuSelectorItem<number> {
    ...
    const disabled$ = getCurrentRangeDisable$(accessor, { workbookTypes: [UnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.Edit, SubUnitPermissionType.SetCellStyle], rangeTypes: [RangeUnitPermissionType.Edit] });
...
export function CopyMenuItemFactory(accessor: IAccessor): IMenuButtonItem {
    return {
        ...
        disabled$: getCurrentRangeDisable$(accessor, { workbookTypes: [UnitPermissionType.Copy], worksheetTypes: [SubUnitPermissionType.Copy], rangeTypes: [RangeUnitPermissionType.View] }),
    };
}
...
export function CutMenuItemFactory(accessor: IAccessor): IMenuButtonItem {
    return {
        ...
        disabled$: getCurrentRangeDisable$(accessor, { workbookTypes: [UnitPermissionType.Edit], rangeTypes: [RangeUnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.Copy, SubUnitPermissionType.Edit] }),
    };
}
...
export function PasteMenuItemFactory(accessor: IAccessor): IMenuButtonItem {
    return {
        ...
        disabled$: menuClipboardDisabledObservable(accessor).pipe(
            combineLatestWith(getCurrentRangeDisable$(accessor, { rangeTypes: [RangeUnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.Edit, SubUnitPermissionType.SetCellStyle, SubUnitPermissionType.SetCellValue], workbookTypes: [UnitPermissionType.Edit] })),
            map(([d1, d2]) => d1 || d2)
        ),
        positions: [
            MenuPosition.CONTEXT_MENU,
...
export function PasteValueMenuItemFactory(accessor: IAccessor): IMenuButtonItem<string> {
    return {
        ...
        disabled$: menuClipboardDisabledObservable(accessor).pipe(
            combineLatestWith(getCurrentRangeDisable$(accessor, { rangeTypes: [RangeUnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.SetCellValue, SubUnitPermissionType.Edit], workbookTypes: [UnitPermissionType.Edit] })),
            map(([d1, d2]) => d1 || d2)
        ),
    };
}
...
export function PasteFormatMenuItemFactory(accessor: IAccessor): IMenuButtonItem<string> {
    return {
        ...
        positions: [PASTE_SPECIAL_MENU_ID],
        disabled$: menuClipboardDisabledObservable(accessor).pipe(
            combineLatestWith(getCurrentRangeDisable$(accessor, { rangeTypes: [RangeUnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.SetCellStyle, SubUnitPermissionType.Edit], workbookTypes: [UnitPermissionType.Edit] })),
            map(([d1, d2]) => d1 || d2)
        ),
    };
}
...
export function PasteColWidthMenuItemFactory(accessor: IAccessor): IMenuButtonItem<string> {
    return {
        ...
        positions: [PASTE_SPECIAL_MENU_ID],
        disabled$: menuClipboardDisabledObservable(accessor).pipe(
            combineLatestWith(getCurrentRangeDisable$(accessor, { rangeTypes: [RangeUnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.SetColumnStyle, SubUnitPermissionType.Edit], workbookTypes: [UnitPermissionType.Edit] })),
            map(([d1, d2]) => d1 || d2)
        ),
    };
}
...
export function PasteBesidesBorderMenuItemFactory(accessor: IAccessor): IMenuButtonItem<string> {
    return {
        ...
        positions: [PASTE_SPECIAL_MENU_ID],
        disabled$: menuClipboardDisabledObservable(accessor).pipe(
            combineLatestWith(getCurrentRangeDisable$(accessor, { rangeTypes: [RangeUnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.Edit, SubUnitPermissionType.SetCellStyle, SubUnitPermissionType.SetCellValue, SubUnitPermissionType.SetRowStyle, SubUnitPermissionType.SetColumnStyle], workbookTypes: [UnitPermissionType.Edit] })),
            map(([d1, d2]) => d1 || d2)
        ),
    };
}
...
export function FitContentMenuItemFactory(accessor: IAccessor): IMenuButtonItem {
    return {
        ...
        disabled$: getCurrentRangeDisable$(accessor, { workbookTypes: [UnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.SetRowStyle, SubUnitPermissionType.Edit], rangeTypes: [RangeUnitPermissionType.Edit] }),
    };
}
...
export function HideColMenuItemFactory(accessor: IAccessor): IMenuButtonItem {
    return {
        ...
        disabled$: getCurrentRangeDisable$(accessor, { workbookTypes: [UnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.Edit, SubUnitPermissionType.SetColumnStyle], rangeTypes: [RangeUnitPermissionType.Edit] }),
    };
}
...
export function ShowRowMenuItemFactory(accessor: IAccessor): IMenuButtonItem {
    ...
    return {
        ...
        disabled$: getCurrentRangeDisable$(accessor, { workbookTypes: [UnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.Edit, SubUnitPermissionType.SetRowStyle], rangeTypes: [RangeUnitPermissionType.Edit] }),
    };
}
...
export function ShowColMenuItemFactory(accessor: IAccessor): IMenuButtonItem {
    ...
    return {
        ...
        disabled$: getCurrentRangeDisable$(accessor, { workbookTypes: [UnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.SetColumnStyle, SubUnitPermissionType.Edit], rangeTypes: [RangeUnitPermissionType.Edit] }),
    };
}
...
export function SetRowHeightMenuItemFactory(accessor: IAccessor): IMenuButtonItem<number> {
    ...
    return {
        ...
        hidden$: getCurrentRangeDisable$(accessor, { workbookTypes: [UnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.Edit, SubUnitPermissionType.SetRowStyle], rangeTypes: [RangeUnitPermissionType.Edit] }),
    };
}
...
export function SetColWidthMenuItemFactory(accessor: IAccessor): IMenuButtonItem<number> {
    ...
    return {
        ...
        hidden$: getCurrentRangeDisable$(accessor, { workbookTypes: [UnitPermissionType.Edit], worksheetTypes: [SubUnitPermissionType.Edit, SubUnitPermissionType.SetColumnStyle], rangeTypes: [RangeUnitPermissionType.Edit] }),
    };
}
