...
export class SelectionShapeExtension {
    ...
    private _controlMoving(moveOffsetX: number, moveOffsetY: number) {
        ...
        const scrollXY = scene.getViewportScrollXYByCursorViewport(Vector2.FromArray([moveOffsetX, moveOffsetY]));
    ...
    private _widgetMoving(moveOffsetX: number, moveOffsetY: number, cursor: CURSOR_TYPE) {
        ...
        const scrollXY = scene.getViewportScrollXYByCursorViewport(Vector2.FromArray([this._startOffsetX, this._startOffsetY]));
