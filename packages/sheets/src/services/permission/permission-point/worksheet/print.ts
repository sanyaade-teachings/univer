...
export class WorksheetPrintPermission implements IPermissionPoint {
    value = true;
    ...
    constructor(public unitId: string, public subUnitId: string) {
        ...
        this.id = `${this.type}.${SubUnitPermissionType.Print}_${unitId}_${subUnitId}` as ISubUnitPermissionId;
    }
}
