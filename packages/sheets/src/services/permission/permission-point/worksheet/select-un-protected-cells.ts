...
export class WorksheetSelectUnProtectedCellsPermission implements IPermissionPoint {
    ...
    subType = SubUnitPermissionType.SelectUnProtectedCells;
    constructor(public unitId: string, public subUnitId: string) {
        this.id = `${this.type}.${SubUnitPermissionType.SelectUnProtectedCells}_${unitId}_${subUnitId}` as ISubUnitPermissionId;
    }
}
